  ...
  return (
    <Card>
      <CardHeader className="bg-red-50 dark:bg-red-900/20 rounded-t-lg">
        ...
        <CardDescription>Immediate help and resources for crisis situations</CardDescription>
      </CardHeader>
          ...
          <TabsContent value="immediate" className="space-y-4 pt-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              <Dialog open={showCallDialog} onOpenChange={setShowCallDialog}>
                ...
                <DialogContent>
                  <DialogHeader>
                    <DialogTitle>Call Crisis Helpline</DialogTitle>
                    <DialogDescription>You're about to be connected to a trained crisis counselor.</DialogDescription>
                  </DialogHeader>
                  <div className="py-4">
                    <div className="flex items-center justify-center gap-4 mb-6">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">National Crisis Helpline</p>
                      </div>
                    </div>
                  ...
                  <DialogFooter className="flex flex-col sm:flex-row gap-2">
                    <Button variant="outline" onClick={() => setShowCallDialog(false)} className="sm:flex-1">
                      Cancel
                    </Button>
                    <Button className="bg-red-600 hover:bg-red-700 sm:flex-1">Call Now</Button>
                  </DialogFooter>
                </DialogContent>
              </Dialog>
            ...
            <div className="border rounded-md overflow-hidden">
              <div className="bg-muted p-3 font-medium">Quick Coping Strategies</div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Breathe in for 4 counts, hold for 4, exhale for 6. Repeat 5 times.
                    </p>
                  </div>
                </div>
                <Separator />
            ...
            <Accordion type="single" collapsible className="w-full">
              <AccordionItem value="item-1">
                ...
                <AccordionContent className="space-y-2">
                  <p className="text-sm">
                    Cravings are temporary and typically peak after 15-30 minutes before subsiding. Here are strategies
                    to help you through them:
                  </p>
                  <ul className="list-disc pl-5 text-sm space-y-1">
                    <li>Delay: Tell yourself you'll wait 15 minutes before acting on the craving</li>
                    <li>Distract: Engage in an activity that requires focus</li>
                    <li>Drink water: Hydration can help reduce cravings</li>
                    <li>Deep breathing: Slow, deliberate breaths to calm your nervous system</li>
                    <li>Distance: Remove yourself from triggering environments</li>
                  </ul>
                ...
                <AccordionContent>
                  <div className="bg-muted p-3 rounded-md">
                    ...
                    <p className="text-xs text-muted-foreground mt-2">
                      10-minute guided meditation specifically designed for addiction recovery
                    </p>
                  </div>
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="item-3">
                ...
                <AccordionContent>
                  <p className="text-sm mb-2">
                    Learn about common withdrawal symptoms, when they're dangerous, and how to manage them safely.
                  </p>
                ...
                <div className="p-3 border rounded-md">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Recovery Specialist</p>
                    </div>
                    <Button size="sm">
                      <Phone className="h-4 w-4 mr-2" />
                      Call
