...
export default function DashboardPage() {
  ...
  const handleCrisisSupport = () => {
    ...
    document.getElementById("crisis-support")?.scrollIntoView({ behavior: "smooth" })
  }
        ...
        <AlertDialog open={showCrisisAlert} onOpenChange={setShowCrisisAlert}>
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                We've noticed you might be experiencing a difficult moment. Would you like to access our crisis support
                resources?
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
              <AlertDialogCancel>I'm okay</AlertDialogCancel>
              <AlertDialogAction className="bg-red-600 hover:bg-red-700" onClick={handleCrisisSupport}>
                Get Support
              </AlertDialogAction>
            </AlertDialogFooter>
          </AlertDialogContent>
              ...
              <>
                  ...
                  <CardContent className="pt-6">
                    <div className="flex justify-between items-center">
                      <div>
                        ...
                        <h3 className="text-2xl font-bold">{streakCount} days</h3>
                      </div>
                ...
                <Card>
                  <CardContent className="pt-6">
                    ...
                    <Progress value={(completedTasksToday / totalTasksToday) * 100} className="h-2 mt-4" />
                  </CardContent>
                </Card>
            ...
            <Card>
              <CardHeader className="pb-3">
                <div className="flex items-center justify-between">
                  ...
                  <Button variant="ghost" size="sm" onClick={() => router.push("/recovery-plan")}>
                    <Edit3 className="h-4 w-4 mr-2" />
                    View Full Plan
                  </Button>
                </div>
                <CardDescription>Complete these tasks to maintain your progress</CardDescription>
              </CardHeader>
              <CardContent>
                {isLoading ? (
            ...
            <Card>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <div>
                  ...
                  <CardDescription>Milestones in your recovery journey</CardDescription>
                </div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">Completed 7 consecutive days</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">Completed 25 recovery tasks</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">Completed 10 wellness activities</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">Reached 30 days sober</p>
                      </div>
                    </div>
                  </div>
                )}
